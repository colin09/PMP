...
namespace com.pmp.model
{
    ...
    public class Model_Project
    {
        ...
        /// 合同号
        /// </summary>
        public string Project_ContractCode { get; set; }
        /// <summary>
        /// 项目状态
        ...
        /// 联系人
        /// </summary>
        public string Project_Linkman { get; set; }
        /// <summary>
        /// 联系方式
        /// </summary>
        public string Project_Mobile { get; set; }
        /// <summary>
        /// 项目描述
        /// </summary>
        ...
        /// 制单人
        /// </summary>
        public int Project_CreatesUserID { get; set; }
        /// <summary>
        /// 项目开始时间
        /// </summary>
        ...
        /// 项目结束时间
        /// </summary>
        public string Project_EndTime { get; set; }

        /// <summary>
        /// 审核状态
        /// [1.审核通过][0.未审核][2.审核未通过]
        /// </summary>
        public int Project_AuditStatus { get; set; }
        /// <summary>
        /// 领取人项目方案
        /// </summary>
        public string Project_GetProgram { get; set; }
        /// <summary>
        /// 创建时间
        /// </summary>
        public string Project_CreatesTime { get; set; }

        /// <summary>
        /// 雇主是否评价
        ///[0.未评价][1.已评价]
        /// </summary>
        public int Project_IsEvaluate_E { get; set; }

        /// <summary>
        /// 实施是否评价
        /// [0.未评价][1.已评价]
        /// </summary>
        public int Project_IsEvaluate_I { get; set; }
